...
public partial class TB_CMCRM_TIPO_COMPROMISSO
{
    ...
    public virtual ICollection<TB_CMCRM_COMPROMISSO_DISPONIVEL_VISTORIA> TB_CMCRM_COMPROMISSO_DISPONIVEL_VISTORIa { get; set; } = new List<TB_CMCRM_COMPROMISSO_DISPONIVEL_VISTORIA>();
