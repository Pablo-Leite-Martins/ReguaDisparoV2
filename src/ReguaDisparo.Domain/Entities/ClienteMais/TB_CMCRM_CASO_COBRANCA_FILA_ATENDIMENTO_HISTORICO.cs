...
public partial class TB_CMCRM_CASO_COBRANCA_FILA_ATENDIMENTO_HISTORICO
{
    public int ID_CASO_COBRANCA_FILA_ATENDIMENTO_HISTORICO { get; set; }
    ...
    public string DS_IDENTIFICADOR { get; set; } = null!;
