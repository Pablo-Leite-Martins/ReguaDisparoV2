...
public partial class TB_CMCRM_CASO_COBRANCA_FILA_ATENDIMENTO
{
    public int ID_CASO_COBRANCA_FILA_ATENDIMENTO { get; set; }
    ...
    public DateTime? DT_RETORNO_FILA { get; set; }
    ...
    public int? ID_USUARIO_BLOQUEIO { get; set; }
}
