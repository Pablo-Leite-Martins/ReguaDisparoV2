...
public partial class TB_CMCRM_CASO_COBRANCA_DADOS_PARCELA
{
    public int ID_CASO_COBRANCA_DADOS_PARCELAS { get; set; }
    ...
    public virtual TB_CMCRM_CASO_COBRANCA_DADO ID_CASO_COBRANCA_DADOSNavigation { get; set; } = null!;
}
