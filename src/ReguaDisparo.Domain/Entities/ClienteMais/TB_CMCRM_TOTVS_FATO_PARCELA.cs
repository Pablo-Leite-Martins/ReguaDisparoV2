...
public partial class TB_CMCRM_TOTVS_FATO_PARCELA
{
    public int ID_TOTVS_FATO_PARCELAS { get; set; }
    ...
    public string? ID_TIPO_PARCELA { get; set; }
    ...
    public string? DS_INDICE_REAJUSTE { get; set; }

    public decimal? NR_JUROS_PARCELA { get; set; }

    public DateTime? DT_ATUALIZACAO { get; set; }

    public int? NR_TIPO_BLOQUEIO { get; set; }
    ...
    public string? NOVA_MODALIDADE { get; set; }

    public string? PREF_CLIENTE { get; set; }

    public string? CLASS_COBRANCA { get; set; }

    public string? DISTR_COBRANCA { get; set; }
}
