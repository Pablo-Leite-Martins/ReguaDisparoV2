...
public partial class TB_CMCRM_PESQUISA_SATISFACAO_SIMPLIFICADA_ENVIO
{
    ...
    public virtual ICollection<TB_CMCRM_PESQUISA_SATISFACAO_SIMPLIFICADA_RESPOSTA> TB_CMCRM_PESQUISA_SATISFACAO_SIMPLIFICADA_RESPOSTa { get; set; } = new List<TB_CMCRM_PESQUISA_SATISFACAO_SIMPLIFICADA_RESPOSTA>();
}
