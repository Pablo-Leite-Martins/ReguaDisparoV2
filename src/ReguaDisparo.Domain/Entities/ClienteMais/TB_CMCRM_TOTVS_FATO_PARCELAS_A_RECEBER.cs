...
public partial class TB_CMCRM_TOTVS_FATO_PARCELAS_A_RECEBER
{
    public int ID_TOTVS_FATO_PARCELAS_A_RECEBER { get; set; }
    ...
    public DateTime? DT_EMISSAO_BOLETO { get; set; }
}
