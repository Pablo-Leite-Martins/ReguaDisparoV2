...
public partial class TB_CMCRM_CASO_COBRANCA_DADO
{
    public int ID_CASO_COBRANCA_DADOS { get; set; }
    ...
    public virtual TB_CMCRM_CASO_COBRANCA_CAMPANHA? ID_CASO_COBRANCA_CAMPANHANavigation { get; set; }

    public virtual TB_CMCRM_CASO_COBRANCA_RESULTADO_CONTATO? ID_CASO_COBRANCA_RESULTADO_CONTATONavigation { get; set; }

    public virtual ICollection<TB_CMCRM_CASO_COBRANCA_DADOS_PARCELA> TB_CMCRM_CASO_COBRANCA_DADOS_PARCELAs { get; set; } = new List<TB_CMCRM_CASO_COBRANCA_DADOS_PARCELA>();
}
