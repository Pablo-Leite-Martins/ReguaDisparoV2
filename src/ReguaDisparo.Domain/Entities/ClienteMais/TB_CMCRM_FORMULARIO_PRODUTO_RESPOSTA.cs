...
public partial class TB_CMCRM_FORMULARIO_PRODUTO_RESPOSTA
{
    ...
    public virtual TB_CMCRM_FORMULARIO_PRODUTO_PERGUNTA ID_FORMULARIO_PRODUTO_PERGUNTANavigation { get; set; } = null!;
