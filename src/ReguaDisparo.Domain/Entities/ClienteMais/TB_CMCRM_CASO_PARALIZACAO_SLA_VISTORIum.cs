...
public partial class TB_CMCRM_CASO_PARALIZACAO_SLA_VISTORIum
{
    ...
    public virtual TB_CMCRM_MOTIVO_NAO_PROCEDENCIum? ID_MOTIVO_NAO_PROCEDENCIANavigation { get; set; }
}
