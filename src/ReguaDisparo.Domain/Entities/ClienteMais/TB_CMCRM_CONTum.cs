...
public partial class TB_CMCRM_CONTum
{
    ...
    public virtual TB_CMCRM_PERFIL_FINANCEIRO_CONTum? ID_PERFIL_FINANCEIRO_CONTANavigation { get; set; }

    public virtual TB_CMCRM_PERFIL_TIPO_CONTum? ID_PERFIL_TIPO_CONTANavigation { get; set; }

    public virtual TB_CMCRM_TIPO_CANAL_ATENDIMENTO? ID_TIPO_CANAL_ATENDIMENTONavigation { get; set; }

    public virtual TB_CMCRM_TIPO_CONTum ID_TIPO_CONTANavigation { get; set; } = null!;
