...
public partial class TB_CMCRM_COMUNICADO_AGENDAMENTO
{
    ...
    public virtual ICollection<TB_CMCRM_COMUNICADO_AGENDAMENTO_AUDIENCIum> TB_CMCRM_COMUNICADO_AGENDAMENTO_AUDIENCIa { get; set; } = new List<TB_CMCRM_COMUNICADO_AGENDAMENTO_AUDIENCIum>();
}
