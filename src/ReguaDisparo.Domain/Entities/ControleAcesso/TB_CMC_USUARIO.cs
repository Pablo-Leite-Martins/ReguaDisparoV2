...
public partial class TB_CMC_USUARIO
{
    ...
    public int? ID_MODULO_PRINCIPAL { get; set; }

    public virtual TB_CMC_PERFIL_USUARIO? ID_PERFIL_USUARIONavigation { get; set; }
    ...
    public virtual ICollection<TB_CMC_CONFIRMACAO_CADASTRAL> TB_CMC_CONFIRMACAO_CADASTRALs { get; set; } = new List<TB_CMC_CONFIRMACAO_CADASTRAL>();
