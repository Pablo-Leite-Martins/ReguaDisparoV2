# ========================================
# ?? SCAFFOLD - CONTROLE_ACESSO
# ========================================
# Script para scaffold da base CLIENTEMAIS_CONTROLE_ACESSO
#
# ?? Uso:
#   1. Edite a connection string se necessário
#   2. Execute: .\scaffold-controle-acesso.ps1
#
# ========================================
...
$OutputDir = "Data/Generated/ControleAcesso"
$ContextName = "ControleAcessoDbContext"
...
Write-Host "?? SCAFFOLD - CONTROLE_ACESSO" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

Write-Host "??? Iniciando scaffold..." -ForegroundColor Yellow
Write-Host "?? Base: CLIENTEMAIS_CONTROLE_ACESSO" -ForegroundColor Gray
...
if ($LASTEXITCODE -eq 0) {
    ...
    Get-ChildItem -Path "$ProjectInfra\$OutputDir" -Filter "*.cs" | ForEach-Object {
        (Get-Content $_.FullName -Raw) -replace 'namespace ReguaDisparo\.Infrastructure\.Data\.Generated;', 'namespace ReguaDisparo.Infrastructure.Data.Generated.ControleAcesso;' | Set-Content $_.FullName -NoNewline
    }
